...
--
myWorkspaces    = ["1|main","2|work","3|chat","4|media"]

-- Border colors for unfocused and focused windows, respectively.
--
myNormalBorderColor  = "#dddddd"
--myFocusedBorderColor = "#ee9a00"
--myFocusedBorderColor = "#a22814"
myFocusedBorderColor = "#16778F"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- screen brightness
    , ((mod4Mask, xK_F7), spawn "xbacklight -inc 20")
    , ((mod4Mask, xK_F6), spawn "xbacklight -dec 20")
